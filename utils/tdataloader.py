...
class CamObjDataset(data.Dataset):
    def __init__(self, image_root, gt_root, edge_root, trainsize):
        ...
        # self.images = [image_root + f for f in os.listdir(image_root) if f.endswith('.png')] # png for xirou
...
class test_dataset:
    ...
    def __init__(self, image_root, gt_root, testsize):
        ...
        self.images = [image_root + f for f in os.listdir(image_root) if f.endswith('.png') or f.endswith('.jpg')]
        # self.images = [image_root + f for f in os.listdir(image_root) if f.endswith('.jpg')]
        # self.images = [image_root + f for f in os.listdir(image_root) if f.endswith('.png')]  # for xirou
        self.gts = [gt_root + f for f in os.listdir(gt_root) if f.endswith('.png')]
        self.images = sorted(self.images)
        self.gts = sorted(self.gts)
