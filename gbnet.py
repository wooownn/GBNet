...
class Net(nn.Module):
    def __init__(self):
        ...
        # self.pvt = pvt_v1(pretrained=True)
        self.pvt = pvt_v2_b2()
        path = '/home/ubuntu/wxd/cod/code/BGNet/models/pvt_v2_b2.pth'
    ...
    def forward(self, x): 
        ...
        x234 = self.cab2(x2r, x34)
        x1234 = self.cab1(x1r, x234)
